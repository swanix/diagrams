...
const LoadingProgress = {
  ...
  applyProgressStyles() {
    ...
    style.textContent = `
      ...
      body.theme-onyx .progress-spinner {
        background-color: var(--canvas-bg, #1a1a1a);
      }
      
      body.theme-onyx .progress-spinner-ring {
...
function initializeEarlyTheme() {
  try {
    ...
    let themeToApply = 'onyx'; // default theme
...
if (!window.ThemeManager) {
  ...
  window.ThemeManager = {
    ...
    getCurrentTheme: function() {
      if (document.body.classList.contains('theme-onyx')) {
        return 'onyx';
      } else if (document.body.classList.contains('theme-snow')) {
        return 'snow';
      }
      return 'onyx'; // default
    },
