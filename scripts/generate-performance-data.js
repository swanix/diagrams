...
function generatePerformanceData() {
  ...
  for (let companyIndex = 0; companyIndex < 42; companyIndex++) {
    ...
    generateCompanyStructure(finalCompanyCode, csvData, nodeCount);
  }
  
  // Guardar archivo
  fs.writeFileSync('src/data/companies-board-performance.csv', csvData);
  console.log(`Archivo generado con ${nodeCount} nodos en 42 árboles`);
}

function generateCompanyStructure(companyCode, csvData, nodeCount) {
  // CEO
